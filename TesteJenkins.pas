<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
    <PropertyGroup>
        <ProjectGuid>{04A70C95-0474-42BC-BF76-EBBA7BD5B1D5}</ProjectGuid>
        ...
        <MainSource>TesteJenkins.dpr</MainSource>
    </PropertyGroup>
    ...
    <PropertyGroup Condition="'$(Base)'!=''">
        ...
        <SanitizedProjectName>TesteJenkins</SanitizedProjectName>
    </PropertyGroup>
    ...
    <ItemGroup>
        ...
        <DCCReference Include="ViewPrincipal.pas">
            <Form>Form1</Form>
    ...
    <ProjectExtensions>
        ...
        <BorlandProject>
            <Delphi.Personality>
                <Source>
                    <Source Name="MainSource">TesteJenkins.dpr</Source>
                </Source>
            </Delphi.Personality>
            <Deployment Version="3">
                <DeployFile LocalName="Win32\Debug\TesteJenkins.exe" Configuration="Debug" Class="ProjectOutput">
                    <Platform Name="Win32">
                        <RemoteName>TesteJenkins.exe</RemoteName>
